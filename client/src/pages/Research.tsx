...
export default function Research() {
  return (
    <div className="min-h-screen">
      ...
      <section className="md:py-20 py-10 bg-gradient-to-br from-yellow-50 to-orange-50">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-8">
              <h2 className="md:text-3xl text-2xl font-bold text-gray-900">Research Overview</h2>
              <a 
                href="/discoveru-research-paper.pdf" 
                download
                className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors shadow-lg hover:shadow-xl md:text-lg text-sm"
              >
