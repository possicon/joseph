...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <section className="md:mt-0 mt-16 md:pt-3 bg-white">
      ...
      <section className="py-16 bg-white">
        ...
        <div className="flex flex-col mx-auto px-6 md:px-10 py-10 md:flex-row gap-4 w-full justify-between">
                ...
                <div className="md:w-[35%] w-full shadow-[inset_0px_3.33px_20.42px_0px_#1650F51F] bg-[#F7F7F7] md:p-6 p-3 rounded-xl flex justify-center items-center">
                    <div className="flex justify-center items-center gap-x-3 md:gap-y-10 gap-y-5 flex-wrap text-[#1F1F1F]">
                        <div className="bg-white space-y-2 p-4 rounded-2xl text-[16.6px] font-base  h-32 flex flex-col items-center justify-center w-[40%] text-center shadow-soft">
                        ...
                        <div className="bg-white space-y-2 p-4 rounded-2xl text-[16.6px] font-base  h-32 flex flex-col items-center justify-center w-[40%] text-center shadow-soft">
                            <h3 className="font-medium leading-[1.3rem]">$50k+ raised for LLS</h3>
                            <img src="icons8-checkmark.svg" className="w-8" alt="" />
                        </div>
                        <div className="bg-white space-y-2 p-4 rounded-2xl flex-col text-[16.6px] font-base  h-32 flex items-center justify-center w-[40%] text-center shadow-soft"><h3 className="leading-[1.3rem] font-medium">Grade A Johns Hopkins</h3>
                            <img src="rocket-svgrepo-com (1).svg" className="w-8" alt="" />
                        </div>
                        <div className="bg-white space-y-2 p-4 flex-col rounded-2xl text-[16.6px] font-base  h-32 flex items-center justify-center w-[40%] text-center shadow-soft"><h3 className="leading-[1.3rem] font-medium">Robotics Competition Win</h3>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 justify-center items-center gap-4 max-w-6xl mx-auto">
            {/* Innovation Hero */}
            <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-transparent hover:border-orange-500 overflow-hidden">
              ...
              <CardContent className="p-6 flex flex-col justify-between h-52 md:h-75 lg:h-60">
